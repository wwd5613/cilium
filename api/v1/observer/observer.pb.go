...
type RelayStatus struct {
	...
	NumNodesTotal uint32 `protobuf:"varint,1,opt,name=num_nodes_total,json=numNodesTotal,proto3" json:"num_nodes_total,omitempty"`
	// num_nodes_queried is the number of nodes queried for this request
	NumNodesQueried uint32 `protobuf:"varint,2,opt,name=num_nodes_queried,json=numNodesQueried,proto3" json:"num_nodes_queried,omitempty"`
	// num_nodes_responded is the number of nodes which responded in this request
	NumNodesResponded uint32 `protobuf:"varint,3,opt,name=num_nodes_responded,json=numNodesResponded,proto3" json:"num_nodes_responded,omitempty"`
	// unresponsive_nodes is a list of nodes which did not respond to this
	// request.
	UnresponsiveNodes    []string `protobuf:"bytes,4,rep,name=unresponsive_nodes,json=unresponsiveNodes,proto3" json:"unresponsive_nodes,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RelayStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RelayStatus.Unmarshal(m, b)
}
...
func (m *RelayStatus) XXX_Size() int {
	return xxx_messageInfo_RelayStatus.Size(m)
}
...
func (m *RelayStatus) GetNumNodesTotal() uint32 {
	if m != nil {
		return m.NumNodesTotal
	}
	return 0
}

func (m *RelayStatus) GetNumNodesQueried() uint32 {
	if m != nil {
		return m.NumNodesQueried
	}
	return 0
}

func (m *RelayStatus) GetNumNodesResponded() uint32 {
	if m != nil {
		return m.NumNodesResponded
	}
	return 0
}

func (m *RelayStatus) GetUnresponsiveNodes() []string {
	if m != nil {
		return m.UnresponsiveNodes
	}
	return nil
}
...
type GetFlowsResponse_Status struct {
	Status *RelayStatus `protobuf:"bytes,2,opt,name=status,proto3,oneof"`
}

func (*GetFlowsResponse_Flow) isGetFlowsResponse_ResponseTypes() {}

func (*GetFlowsResponse_Status) isGetFlowsResponse_ResponseTypes() {}
...
func (m *GetFlowsResponse) GetStatus() *RelayStatus {
	if x, ok := m.GetResponseTypes().(*GetFlowsResponse_Status); ok {
		return x.Status
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*RelayStatus)(nil), "observer.RelayStatus")
...
var fileDescriptor_3004233a4a5969ce = []byte{
	...
	,
}
